...
type StudyInfoGenderCheckboxProps = {
  name: Path<PatientInfoFormFieldsType>;
  control: IFormControlInputProps<PatientInfoFormFieldsType>['control'];
  disabled?: boolean;
  watch: UseFormWatch<PatientInfoFormFieldsType>;
};

/**
 * Danh sách checkbox,hiển thị,lựa chọn giới tính cho bệnh nhân
 */
export const StudyInfoGenderCheckbox: FC<StudyInfoGenderCheckboxProps> = (props) => {
